import GroupValidatorFactory, { GroupRules, GroupValidator } from '../group.validator';

describe('Group Validator Unit Tests', () => {
	let validator: GroupValidator;

	beforeEach(() => (validator = GroupValidatorFactory.create()));
